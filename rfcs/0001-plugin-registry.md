...
| `sections`    | object    | no       | Map of human-readable text sections. FAIR-recognised keys: `description`, `installation`, `faq`, `changelog`, `security`. Each value: `maxLength` 30000 bytes, `maxGraphemes` 3000. Section values are CommonMark-flavoured Markdown. See [Sections and long-form documentation](#sections-and-long-form-documentation) below.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
The `sections` field carries _summaries_, not the full long-form documentation. Each entry is capped at 30 KB / 3000 graphemes — enough for a paragraph or two of a description, the most-recent release's changelog notes, brief installation instructions — but deliberately too small for the kind of multi-page documentation that lives in a project README.
